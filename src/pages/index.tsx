...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`SendQwik`}</title>

        <meta
          name="description"
          content="Welcome to SendQwik - Your comprehensive solution for Email Platform Analytics and Campaign Management. Revolutionize your email strategies, make informed decisions, and enhance engagement with our powerful tools and insights."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556155092-490a1ba16284?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbWFpbCUyMGFuYWx5dGljc3xlbnwwfHx8fDE2OTIxMDYyNTR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to SendQwik - Your comprehensive solution for Email Platform Analytics and Campaign Management. Revolutionize your email strategies, make informed decisions, and enhance engagement with our powerful tools and insights.`}
            </Text>
            <Box
