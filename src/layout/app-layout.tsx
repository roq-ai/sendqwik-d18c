...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'admin', 'marketing-manager', 'data-analyst'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Alerts', path: '/alerts', entity: 'alert', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
    { name: 'Campaigns', path: '/campaigns', entity: 'campaign', service: AccessServiceEnum.PROJECT, icon: FiTarget },
    {
      name: 'Dashboards',
      path: '/dashboards',
      entity: 'dashboard',
