...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'campaign.create': {
    roles: ['owner', 'admin', 'marketing-manager', 'data-analyst'],
    key: 'campaign-created',
    tenantPath: ['organization', 'user', 'campaign'],
    userPath: [],
  },
  'dashboard.update': {
    roles: ['owner', 'admin', 'marketing-manager', 'data-analyst'],
    key: 'dashboard-updated',
    tenantPath: ['organization', 'user', 'dashboard'],
    userPath: [],
  },
  'alert.create': {
    roles: ['owner'],
    key: 'alert-triggered',
    tenantPath: ['organization', 'user', 'alert'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'admin', 'marketing-manager', 'data-analyst'];
